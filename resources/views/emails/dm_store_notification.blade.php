...
<h3 style="text-align: center"><font style="color: darkgreen; font-weight: bold">{{$user_client->name}}</font>{{__(' has sent you a direct message in')}} <a style="color: limegreen; font-weight: bold" href="http://tiendademo1.test">TuMiniMercado</a></h3>

@component('mail::button', ['url' => 'http://tiendademo1.test/admin/order/'.$date_order, 'color' => 'success'])
