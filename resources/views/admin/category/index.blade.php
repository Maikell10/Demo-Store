    ...
    <div class="col-12">
        <div class="card card-success card-outline">
            ...
            <div class="card-body table-responsive p-0">
                <a class="m-2 float-right btn btn-primary" href="{{route('admin.category.create')}}">Crear <i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a class="btn btn-default" href="{{route('admin.category.show',$categoria->slug)}}"><i
                                        class="far fa-eye"></i></a>
                                <a class="btn btn-info" href="{{route('admin.category.edit',$categoria->slug)}}"><i
