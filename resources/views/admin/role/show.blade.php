...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Ver Rol</h2>
                ...
                <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" placeholder="Descripción" name="description" id="description"
                            rows="3" readonly>{{ old('description',$role->description)}}</textarea>
                    </div>
                    ...
                    @endforeach
                    <hr>
                    <a href="{{route('admin.role.edit',$role->id)}}" class="btn btn-success">Editar</a>
