...
<head>
    ...
    <meta name="description" content="Tu Solución Empresarial, de Necesidades y Lujos">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="icon" href="{{ asset('asset/images/logo_size.jpg') }}">
...
<body>
    ...
    <div id="app">
        ...
        <div class="menu">
            ...
            <!-- Search -->
            <div class="mb-5 ml-5"><img width="200rem" src="{{ asset('asset/images/logo.png') }}" alt=""></div>
            <div class="menu_search">
                <form action="#" id="menu_search_form" class="menu_search_form">
                    <input type="text" class="search_input" placeholder="Búsqueda" required="required">
                ...
                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="logo">
                        <a href="{{ url('/') }}">
                            <div class="d-flex flex-row align-items-center justify-content-start">
                                <div><img width="70px" src="{{ asset('asset/images/logo.png') }}" alt=""></div>
                                <div>TuMiniMercado</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="header_search ml-auto">
                        <form action="#" id="header_search_form">
                            <input type="text" class="search_input" placeholder="Búsqueda" required="required">
                            <button class="header_search_button"><img
                                    src="{{ asset('asset/images/search.png') }}" alt=""></button>
                        </form>
                    </div>
                    <div class="d-flex flex-row align-items-center justify-content-start ml-auto">
                        <!-- Cart -->
                        <div class="cart mr-4"><a href="cart.html">
                                <div><img class="svg" src="{{ asset('asset/images/cart.svg') }}"
                                        alt="{{ asset('asset/images/cart.svg') }}">
                                    <div>1</div>
                                </div>
                            </a></div>

                        <!-- User -->
                        <div class="cart d-flex flex-row align-items-center justify-content-start"><a href="login"
                                data-toggle="tooltip" data-placement="bottom" title="{{ __('Login') }}">
                                <div>
                                    @if ($user != null)
                                    <img class="svg" src="{{ asset('asset/images/icon_2.svg') }}"
                                        alt="{{ asset('asset/images/icon_2.svg') }}">
                                    @else
                                    <img class="svg" src="{{ asset('asset/images/user.svg') }}"
                                        alt="{{ asset('asset/images/user.svg') }}">
                                    @endif
                                </div>
                            </a></div>
                            ...
                            <div class="col-lg-4 footer_col">
                                <div class="footer_about">
                                    <div class="footer_logo">
                                        <a href="#">
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <div class="footer_logo_icon"><img
                                                        src="{{ asset('asset/images/logo_2.png') }}" alt="">
                                                </div>
                                                <div>TuMiniMercado</div>
                                            </div>
                                        </a>
