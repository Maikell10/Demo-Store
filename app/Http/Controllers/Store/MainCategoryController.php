...
class MainCategoryController extends Controller
{
    ...
    public function show($slug)
    {
        ...
        //return $category;
        $productos = Product::with('images', 'main_category', 'main_category.sub_category','main_category.sub_category.category', 'users')->join('main_categories','main_categories.id','=','products.main_category_id')->where('activo', 'Si')->where('main_category_id', $main_category->id)->inRandomOrder()->paginate(10, 
