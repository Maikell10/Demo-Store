...
class SaleController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->id == 1) {
            $sales = Sale::where('state', 'Finalizada')->with('products','users')->orderBy('updated_at', 'desc')->get();

            $distinct_sale = Sale::select('state', 'sales.updated_at', 'sales.created_at')->join('product_user', 'sales.product_id', '=', 'product_user.product_id')->where('state', 'Finalizada')->orderBy('sales.created_at', 'desc')->get();
        } else {
            $sales = Sale::select('sales.state', 'sales.price_sale', 'sales.cantidad', 'sales.updated_at', 'sales.created_at', 'sales.user_id', 'sales.product_id', 'sales.state')->join('product_user', 'sales.product_id', '=', 'product_user.product_id')->where('product_user.user_id', Auth::user()->id)->with('products','users')->where('sales.state', 'Finalizada')->orderBy('sales.updated_at', 'desc')->get();

            $distinct_sale = Sale::select('state', 'sales.updated_at', 'sales.created_at')->join('product_user', 'sales.product_id', '=', 'product_user.product_id')->where('product_user.user_id', Auth::user()->id)->where('sales.state', 'Finalizada')->orderBy('sales.created_at', 'desc')->get();
        }
    ...
    public function show($id)
    {
        ...
        if (Auth::user()->id == 1) {
            $sales = Sale::select('sales.id','sales.state', 'sales.price_sale', 'sales.cantidad', 'sales.updated_at', 'sales.created_at', 'sales.user_id', 'sales.product_id', 'sales.status')->join('product_user', 'sales.product_id', '=', 'product_user.product_id')->where('sales.updated_at', $id)->with('products','users')->orderBy('sales.updated_at', 'desc')->get();
            ...
            $sales = Sale::select('sales.id','sales.state', 'sales.price_sale', 'sales.cantidad', 'sales.updated_at', 'sales.created_at', 'sales.user_id', 'sales.product_id', 'sales.status')->join('product_user', 'sales.product_id', '=', 'product_user.product_id')->where('product_user.user_id', Auth::user()->id)->where('sales.updated_at', $id)->with('products','users')->orderBy('sales.updated_at', 'desc')->get();
        ...
        return view('admin.sale.show', compact('user', 'sales','notifications','d_messages','cant_dm_new','direct_m','rating_user','rating_store'));
    }
